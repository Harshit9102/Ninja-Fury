...
if(score===0 || score<0){
  ...
  text("Hint!!!",500,100);
  fill("aqua");
  text("Press (SPACE) to jump",580,100)
  fill("yellow");
  text("Collect Chests for Points!!!",800,140);
  fill("pink");
  text("Spiky Balls can decrease your score!!!",500,180);
  fill("red");
  text("SPIKES of RODS can KILL you",800,220);
}
}
